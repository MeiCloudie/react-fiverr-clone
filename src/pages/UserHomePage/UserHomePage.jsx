    ...
    <div className="container flex flex-col h-full my-6">
      ...
      <section>
        ...
        <div className="flex justify-center my-4">
          <button className="bg-black text-white font-bold rounded-md px-4 py-2 hover:opacity-70 duration-100">
            Join now
          </button>
        </div>
      </section>
      ...
      <section className="bg-amber-950 text-center rounded-lg py-10 my-6">
        ...
        <div className="flex justify-center mt-10">
          <button className="bg-white text-black font-bold rounded-md px-4 py-2 hover:opacity-70 duration-100">
            Join Fiverr
          </button>
        </div>
      </section>
